...
set_property PACKAGE_PIN U16 [get_ports {opA_LED}]	
## Sets the LED to use 3.3V logic		
	set_property IOSTANDARD LVCMOS33 [get_ports {opA_LED}]    
	
set_property PACKAGE_PIN E19 [get_ports {opB_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {opB_LED}]
set_property PACKAGE_PIN U19 [get_ports {sum_LED}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sum_LED}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports calcButton]						
