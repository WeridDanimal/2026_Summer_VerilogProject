...
set_property PACKAGE_PIN U16 [get_ports {slow_clk}]	
## Sets the LED to use 3.3V logic		
	set_property IOSTANDARD LVCMOS33 [get_ports {slow_clk}]    
	
set_property PACKAGE_PIN E19 [get_ports {counter_clk}]					
...
set_property PACKAGE_PIN P3 [get_ports {countOut[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {countOut[0]}]
set_property PACKAGE_PIN N3 [get_ports {countOut[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {countOut[1]}]
set_property PACKAGE_PIN P1 [get_ports {countOut[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {countOut[2]}]
set_property PACKAGE_PIN L1 [get_ports {countOut[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {countOut[3]}]
