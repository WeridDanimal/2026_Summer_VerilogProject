...
(   input clock,
   ...
   debouncer DEBOUNCE_2 (
    ...
    memHandler_debug mem(clock,reset,agexOut_valid,agexResult,registers[DR], write_en[0],write_en[1],read_en[0],read_en[1],
    regFile_output,regFile_writeInput,mem_writeEn, memAddress, memOutput,mem_ready);
